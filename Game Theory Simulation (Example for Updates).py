...
class PlayerSimulation:
    def __init__(self, num_players=4, box_size=3, speed=0.1, interaction_distance=0.3, new_players_probability=0.05):
    ...
    def close_event(self, event):
        ...
        for players, strategy in strategies.items():
            print(f"{players}: {strategy}")
...
your_instance.num_players = 1000
